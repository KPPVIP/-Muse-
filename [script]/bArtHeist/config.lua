...
Config.SellLocations = {
    {
        callMarker = vector3(778.84, 4183.63, 41.79), -- marquer
        driveTo = { pos = vector3(770.81, 4184.11, 40.53), heading = 262.36 }, -- revender
        spawn = { pos = vector3(743.03, 4187.66, 40.69), heading = 262.36} -- spown vl
    }
}
